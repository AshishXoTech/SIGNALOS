...
const TEAMS: Team[] = [
  ...
  {
    id: "t9",
    name: "Coastal Response Foxtrot",
    unit: "Odisha Cyclone Cell",
    type: "SDRF",
    status: "deployed",
    personnel: 18,
    location: "Puri Coastal Grid",
    distance: "6.8 km from INC-1037",
    capabilities: ["Cyclone", "Evacuation", "Flood Rescue"],
    equipment: ["Boats", "Satellite Phones", "Generators"],
  ...
  {
    id: "t10",
    name: "Urban Search Golf",
    unit: "Sikkim Emergency Cell",
    type: "NDRF",
    status: "deployed",
    personnel: 24,
    location: "Gangtok Market Road",
    distance: "1.1 km from INC-1036",
    capabilities: ["Earthquake", "Structural Assessment", "K9 Search"],
    equipment: ["Drones", "Acoustic Sensors", "Shoring Kits"],
  ...
  {
    id: "t11",
    name: "Hazmat Support Hotel",
    unit: "Bengaluru Fire Command",
    type: "Fire",
    status: "returning",
    personnel: 9,
    location: "Returning to Peenya Station",
    distance: "4.6 km from INC-1035",
    capabilities: ["Industrial Fire", "Hazmat", "Ventilation"],
    equipment: ["Foam Tender", "Thermal Camera", "PPE"],
