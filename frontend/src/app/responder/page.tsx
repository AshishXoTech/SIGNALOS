...
export default function ResponderPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      {/* 🇮🇳 OFFICIAL GOVERNMENT HEADER (Full Width) */}
      <GovHeader />

      {/* 🛡 DUTY SESSION SECURITY BANNER (Full Width) */}
      <SessionSecurityBanner />

      {/* MOBILE RESPONDER APP CONTAINER (Centered) */}
      <div className="flex-1 flex flex-col bg-[linear-gradient(135deg,rgba(255,103,31,0.08),#f8fafc_36%,rgba(4,106,56,0.08))] max-w-md w-full mx-auto border-x border-slate-200 shadow-2xl relative">
        <div className="h-1.5 bg-[linear-gradient(90deg,#ff671f_0_33%,#ffffff_33%_66%,#046a38_66%_100%)] shrink-0" />
        
        {/* Top bar */}
        <div className="bg-white/95 backdrop-blur-xl border-b border-slate-200 px-4 py-3 flex items-center justify-between sticky top-0 z-20 shadow-sm shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* The Logout button here is optional now since it's in the banner, but kept to preserve your logic */}
            <button
              type="button"
        ...
        {/* Demo strip */}
        <div className="bg-[linear-gradient(90deg,rgba(255,103,31,0.12),rgba(255,255,255,0.96),rgba(4,106,56,0.12))] border-b border-orange-100 px-3 py-2 text-[10px] font-bold text-slate-700 text-center shrink-0">
